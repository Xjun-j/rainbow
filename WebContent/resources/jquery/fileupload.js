...
jQuery
    .extend({
        ...
        invenoFormFileUpload: function (s) {
        	...
        	/*
            if (window.ActiveXObject && (jQuery.browser.version == "9.0" || jQuery.browser.version == "8.0" || jQuery.browser.version == "7.0" )) {
        ...
        createUploadIframe: function (id, uri) {
            ...
            /*
             * if(window.ActiveXObject) { var io = document.createElement('<iframe
             * id="' + frameId + '" name="' + frameId + '" />'); if(typeof
             * uri== 'boolean'){ io.src = 'javascript:false'; } else
             * if(typeof uri== 'string'){ io.src = uri; } }
             */
